<?php 
	...
	$sql1 = "select * from member where id like '$_SESSION[id]'";
	...
	if($_GET['act'] == update){
		$sql2 = "update member set phonenumber = '$_POST[phonenumber]', gender = '$_POST[gender]', birthday = '$_POST[birthday]', address = '$_POST[address]', introduction = '$_POST[introduction]' where id = '$_SESSION[id]'";
		$result2 = mysqli_query($conn, $sql2);

		if($result2){
			echo "<script>alert('會員資料修改成功');parent.location.href='/member';</script>";
		}else{
